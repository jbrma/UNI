...
public:
	...
	/** INDICA AQUÍ JUSTIFICADAMENTE LA COMPLEJIDAD DE LA OPERACIÓN hundirAlMayor
	...
	**/
	void hundirAlMayor() {
		...
		auto premax = nullptr;
		auto max = this->cima;
		auto anterior = this->cima;
		auto actual = this->cima->_sig;


		for (auto n = this->cima; n->_sig != nullptr; n = n->_sig) {
