...
void ListLinkedDouble::zip(ListLinkedDouble &other) {
    ...
    /* COSTE */
    // El coste es O(min(N,M)), donde N y M son los tamaños de las listas this y other, el metodo
    // recorre las dos listas a la vez, por lo que el numero de iteraciones es igual al tamaño
    // de la lista mas corta, y todas las asignaciones de cada iteracion son O(1).
}
