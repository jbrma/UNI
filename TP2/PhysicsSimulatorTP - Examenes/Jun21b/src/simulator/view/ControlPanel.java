...
public class ControlPanel extends JPanel implements SimulatorObserver{
	...
	private void botonMax() {
		
		botonMax = new JButton();
		botonMax.setToolTipText("Total force per body");
		botonMax.setIcon(new ImageIcon("resources/icons/max.png"));
		...
		_toolaBar.add(botonMax);
	}
	
	private void creaTotalForce() {
		
		if(totalforceDialog == null)
			totalforceDialog = new TotalForceDialog((Frame) SwingUtilities.getWindowAncestor(this), _ctrl);
